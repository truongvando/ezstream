...
<body class="min-h-screen gradient-bg subtle-pattern">
    ...
    <div class="absolute top-6 left-6 z-20">
        <a href="{{ route('welcome') }}" class="flex items-center text-gray-600 hover:text-red-600 transition-all duration-300 hover-lift">
            ...
            <div class="glass-card rounded-3xl p-8 hover-lift">
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-600">
                        Chưa có tài khoản? 
                        <a href="{{ route('register') }}" class="text-red-600 font-bold hover:text-red-700 transition-all">
                            Đăng ký ngay
                        </a>
                    </p>
                </div>
