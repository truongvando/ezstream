<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            <div class="w-12 h-12 {{ auth()->user()->isAdmin() ? 'bg-red-500' : 'bg-blue-500' }} rounded-full flex items-center justify-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                ...
                                <span class="font-semibold text-blue-600 dark:text-blue-400">{{ auth()->user()->streamConfigurations()->count() }}</span>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                ...
                                <span class="font-semibold text-green-600 dark:text-green-400">{{ auth()->user()->files()->count() }}</span>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6">
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('dashboard') }}" class="block w-full px-4 py-2 bg-blue-100 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/40 transition-colors duration-200 text-center text-sm font-medium">
                                📊 Về Dashboard
                            </a>
                            @if(!auth()->user()->isAdmin())
