...
<div x-data="{ 
    showSchedule: @entangle('enable_schedule'),
    showAdvanced: false 
}" 
            ...
            <form wire:submit.prevent="{{ $showCreateModal ? 'store' : 'update' }}">
                <div class="bg-white dark:bg-gray-800 px-6 py-4 space-y-6">
                    ...
                    <div>
                            ...
                            @if($userFiles && count($userFiles) > 0)
                                @foreach($userFiles as $file)
                                    <label class="flex items-center space-x-3 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded">
                                        <input type="checkbox" wire:model="user_file_ids" value="{{ $file->id }}"
                        ...
                        @error('user_file_ids') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            @error('stream_key') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4 flex justify-end space-x-3">
                    ...
                    <button type="submit"
                        ...
                        {{ $showCreateModal ? 'Tạo Stream' : 'Cập Nhật' }}
                    </button>
                </div>
            </form>
        </div>
