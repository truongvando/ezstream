                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $stats['total_transactions'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-gray-100 truncate">${{ number_format($stats['total_revenue'], 2) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $stats['pending_transactions'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $stats['failed_transactions'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                @forelse ($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <span class="truncate block max-w-24">${{ number_format($transaction->amount, 2) }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
