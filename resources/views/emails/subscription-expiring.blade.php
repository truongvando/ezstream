    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="warning-box">
                ...
                <p>Gói <strong>{{ $package_name }}</strong> của bạn sẽ hết hạn trong <strong>{{ $days_remaining }} ngày</strong>.</p>
                <p><strong>Ngày hết hạn:</strong> {{ $expires_at->format('d/m/Y H:i') }}</p>
            </div>
            
            <div class="package-info">
                <h3>📦 Thông tin gói hiện tại</h3>
                <ul>
                    <li><strong>Tên gói:</strong> {{ $package_name }}</li>
                    <li><strong>Số streams:</strong> {{ $max_streams }} luồng</li>
                    <li><strong>Hết hạn:</strong> {{ $expires_at->format('d/m/Y H:i') }}</li>
                </ul>
            </div>
        ...
        <div class="footer">
            ...
            <p>© {{ date('Y') }} VPS Live Stream Control. All rights reserved.</p>
        </div>
    </div>
</body>
</html> 