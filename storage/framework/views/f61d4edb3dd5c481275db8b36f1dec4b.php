                            ...
                            <div class="flex items-center">
                                <div class="flex-1">
                                    <div class="flex justify-between text-sm mb-1">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($vps['disk_total_gb'] > 0): ?>
                                            <span class="text-xs text-gray-500 dark:text-gray-400">
                                                <?php echo e(number_format($vps['disk_used_gb'], 1)); ?>/<?php echo e(number_format($vps['disk_total_gb'], 1)); ?>GB
                                            </span>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <div class="flex items-center">
                                            ...
                                            <span class="font-medium text-gray-900 dark:text-white">
                                                <?php echo e(number_format($vps['network_recv_mb'] / 1024, 1)); ?>GB
                                            </span>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <span class="font-medium text-gray-900 dark:text-white">
                                                <?php echo e(number_format($vps['network_sent_mb'] / 1024, 1)); ?>GB
                                            </span>
                                        </div>
                                    </div>
