<div>
    <form action="<?php echo e($post->exists ? route('admin.blog.update', $post->id) : route('admin.blog.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <!--[if BLOCK]><![endif]--><?php if($post->exists): ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-semibold text-gray-900 dark:text-white">
                        <?php echo e($post->exists ? 'Sửa Link Card' : 'Tạo Link Card mới'); ?>
                ...
                <div class="space-x-4">
                    <a href="<?php echo e(route('admin.blog.index')); ?>" class="rounded-md bg-white dark:bg-gray-700 px-3 py-2 text-sm font-semibold text-gray-900 dark:text-gray-200 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600">
                        Hủy
                    </a>
                    ...
                    <div class="rounded-lg bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-900/5 dark:ring-white/10">
                        <div class="p-6 space-y-6">
                            <div>
                                ...
                                <input name="title" type="text" id="title" value="<?php echo e(old('title', $title)); ?>" class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Tiêu đề cho link card" required>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <input name="link" type="url" id="link" value="<?php echo e(old('link', $link)); ?>" class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="https://example.com/subdomain" required>
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-6">
                                ...
                                <select name="status" id="status" class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 dark:text-white dark:bg-gray-700 ring-1 ring-inset ring-gray-300 dark:ring-gray-600 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                                    <option value="DRAFT" <?php echo e(old('status', $status) == 'DRAFT' ? 'selected' : ''); ?>>Bản nháp</option>
                                    <option value="PUBLISHED" <?php echo e(old('status', $status) == 'PUBLISHED' ? 'selected' : ''); ?>>Công khai</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="text-center">
                                        <div id="image-container">
                                            <!--[if BLOCK]><![endif]--><?php if($existing_featured_image): ?>
                                                <img id="image-preview" src="<?php echo e($existing_featured_image); ?>" class="mx-auto h-32 w-auto object-cover rounded-lg shadow-sm">
