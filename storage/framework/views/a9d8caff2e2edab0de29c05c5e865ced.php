<?php $__env->startSection('title', 'Sửa bài viết: ' . $post->title); ?>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Sửa bài viết: <?php echo e($post->title); ?></h1>
            </div>

            <form action="<?php echo e(route('admin.blog.update', $post)); ?>" method="POST" enctype="multipart/form-data" class="p-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="excerpt" id="excerpt" rows="3" 
                                      class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500"><?php echo e(old('excerpt', $post->excerpt)); ?></textarea>
                        </div>
                    </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="status" id="status" 
                                    ...
                                    <option value="PUBLISHED" <?php echo e(old('status', $post->status) === 'PUBLISHED' ? 'selected' : ''); ?>>Xuất bản</option>
                                </select>
                            </div>
                            ...
                            <?php if($post->featured_image): ?>
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Ảnh đại diện hiện tại</label>
                                    <img src="<?php echo e(asset('storage/' . $post->featured_image)); ?>" alt="Current featured image" class="w-full h-32 object-cover rounded-md">
                                </div>
                            <?php endif; ?>

                            <!-- Featured Image -->
                            <div class="mb-4">
                                <label for="featured_image" class="block text-sm font-medium text-gray-700 dark:text-gray-300"><?php echo e($post->featured_image ? 'Thay đổi ảnh đại diện' : 'Ảnh đại diện'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="url" name="external_link" id="external_link" value="<?php echo e(old('external_link', $post->external_link)); ?>"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="meta_description" id="meta_description" rows="3" 
                                              class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500"><?php echo e(old('meta_description', $post->meta_description)); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\ezstream\resources\views\admin\blog\edit.blade.php ENDPATH**/ ?>