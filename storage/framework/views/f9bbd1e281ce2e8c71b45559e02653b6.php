     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="<?php echo e(route('youtube.index')); ?>" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200">
                    Quay lại Monitoring
                </a>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\ezstream\resources\views/youtube-monitoring/alerts.blade.php ENDPATH**/ ?>