...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['status', 'class' => 'h-6 w-6']));
...
foreach (array_filter((['status', 'class' => 'h-6 w-6']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<svg xmlns="http://www.w3.org/2000/svg" class="<?php echo e($class); ?> <?php echo e($iconClass); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <?php echo $path; ?>

</svg> <?php /**PATH D:\laragon\www\ezstream\resources\views/components/stream-status-icon.blade.php ENDPATH**/ ?>