            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Giá (USD/tháng)</th>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                            ...
                            ?>
                            <div class="font-medium text-green-600">$<?php echo e(number_format($package->price, 2)); ?></div>
                            <div class="text-xs text-gray-400">≈ <?php echo e(number_format($vndAmount, 0, ',', '.')); ?> VND</div>
                        </td>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                <label for="price" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Giá (USD/tháng)</label>
                                <input type="number" step="0.01" wire:model.defer="price" id="price" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Ví dụ: 15.99">
                                <p class="mt-1 text-xs text-gray-500">Nhập giá USD, hệ thống sẽ tự động hiển thị VND tương ứng</p>
