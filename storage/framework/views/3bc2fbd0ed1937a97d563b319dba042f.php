...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data="{ darkMode: localStorage.getItem('darkMode') === 'true' || (!localStorage.getItem('darkMode') && window.matchMedia('(prefers-color-scheme: dark)').matches) }" 
    ...
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', config('app.name', 'EZStream')); ?></title>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('favicon.ico')); ?>?v=<?php echo e(filemtime(public_path('favicon.ico'))); ?>">
        <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('favicon.ico')); ?>?v=<?php echo e(filemtime(public_path('favicon.ico'))); ?>">
        <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('favicon.ico')); ?>?v=<?php echo e(filemtime(public_path('favicon.ico'))); ?>">
            ...
            <nav class="bg-white dark:bg-gray-800 shadow-lg border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="flex items-center space-x-8">
                            ...
                            <div class="hidden md:flex space-x-1">
                                <?php if(auth()->user()->isAdmin()): ?>
                                    ...
                                    <a href="<?php echo e(route('admin.streams')); ?>" class="px-4 py-2 rounded-lg <?php echo e(request()->routeIs('admin.streams') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-semibold' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-all duration-200">
                                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?php echo e(route('admin.users')); ?>" class="px-4 py-2 rounded-lg <?php echo e(request()->routeIs('admin.users') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-semibold' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-all duration-200">
                                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?php echo e(route('admin.vps-servers')); ?>" class="px-4 py-2 rounded-lg <?php echo e(request()->routeIs('admin.vps-servers') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-semibold' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-all duration-200">
                                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?php echo e(route('admin.blog.index')); ?>" class="px-4 py-2 rounded-lg <?php echo e(request()->routeIs('admin.blog.*') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-semibold' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-all duration-200">
                                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?php echo e(route('blog.index')); ?>" class="px-4 py-2 rounded-lg <?php echo e(request()->routeIs('blog.*') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-semibold' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-all duration-200">
                                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php else: ?>
                                    <!-- User Navigation -->
                                    <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-semibold' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-all duration-200">
                                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?php echo e(route('user.streams')); ?>" class="px-4 py-2 rounded-lg <?php echo e(request()->routeIs('user.streams') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-semibold' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-all duration-200">
                                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                                        </svg>
                                        Quản Lý Stream
                                    ...
                                    <a href="<?php echo e(route('file.manager')); ?>" class="px-4 py-2 rounded-lg <?php echo e(request()->routeIs('file.manager') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-semibold' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-all duration-200">
                                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center space-x-4">
                            <!-- Notifications Bell -->
                            <button class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 relative">
                                ...
                                <!-- Notification dot (có thể ẩn/hiện dựa trên logic) -->
                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open" class="flex items-center space-x-3 bg-gray-100 dark:bg-gray-700 rounded-lg px-3 py-2 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-200">
                                    <!-- User Avatar -->
                                    <div class="w-8 h-8 <?php echo e(auth()->user()->isAdmin() ? 'bg-red-500' : 'bg-blue-500'); ?> rounded-full flex items-center justify-center">
                                    ...
                                    <div class="hidden md:block text-left">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 flex items-center">
                                            <?php echo e(Str::limit(Auth::user()->email, 20)); ?>
                                ...
                                <!-- Dropdown Menu -->
                                <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100 transform scale-100" x-transition:leave-end="opacity-0 transform scale-95" class="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50">
                                    
                                    <!-- User Info Section -->
                                    <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                                        <div class="flex items-center space-x-3">
                                            <div class="w-10 h-10 <?php echo e(auth()->user()->isAdmin() ? 'bg-red-500' : 'bg-blue-500'); ?> rounded-full flex items-center justify-center">
                                                <span class="text-sm font-semibold text-white"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></span>
                                            </div>
                                            <div>
                                                <p class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e(Auth::user()->name); ?></p>
                                    ...
                                    <!-- Menu Items -->
                                    <div class="py-2">
                                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                                        ...
                                        <?php if(!auth()->user()->isAdmin()): ?>
                                                                <a href="<?php echo e(route('services')); ?>" class="flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                            <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                            </svg>
                            Gói Dịch Vụ
                ...
                <div class="md:hidden hidden border-t border-gray-200 dark:border-gray-700 transition-colors duration-200" id="mobile-menu">
                    <div class="px-2 pt-2 pb-3 space-y-1 bg-gray-50 dark:bg-gray-800 transition-colors duration-200">
                        <?php if(auth()->user()->isAdmin()): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-3 py-2 rounded-md text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-blue-100 dark:bg-blue-900' : ''); ?>">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                                </svg>
                                Admin Dashboard
                            </a>
                            <a href="<?php echo e(route('admin.streams')); ?>" class="block px-3 py-2 rounded-md text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 <?php echo e(request()->routeIs('admin.streams') ? 'bg-blue-100 dark:bg-blue-900' : ''); ?>">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                                </svg>
                                Quản lý Streams
                            </a>
                            <a href="<?php echo e(route('admin.users')); ?>" class="block px-3 py-2 rounded-md text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 <?php echo e(request()->routeIs('admin.users') ? 'bg-blue-100 dark:bg-blue-900' : ''); ?>">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                                </svg>
                                Người dùng
                            </a>
                            <a href="<?php echo e(route('admin.blog.index')); ?>" class="block px-3 py-2 rounded-md text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 <?php echo e(request()->routeIs('admin.blog.*') ? 'bg-blue-100 dark:bg-blue-900' : ''); ?>">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/>
                                </svg>
                                Quản lý Blog
                            </a>
                            <a href="<?php echo e(route('blog.index')); ?>" class="block px-3 py-2 rounded-md text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 <?php echo e(request()->routeIs('blog.*') ? 'bg-blue-100 dark:bg-blue-900' : ''); ?>">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="block px-3 py-2 rounded-md text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-100 dark:bg-blue-900' : ''); ?>">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"/>
                                </svg>
                                Bảng điều khiển
                            </a>
                            <a href="<?php echo e(route('user.streams')); ?>" class="block px-3 py-2 rounded-md text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 <?php echo e(request()->routeIs('user.streams') ? 'bg-blue-100 dark:bg-blue-900' : ''); ?>">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                                </svg>
                                Quản Lý Stream
                            </a>
                            <a href="<?php echo e(route('file.manager')); ?>" class="block px-3 py-2 rounded-md text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 <?php echo e(request()->routeIs('file.manager') ? 'bg-blue-100 dark:bg-blue-900' : ''); ?>">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                                </svg>
                                Quản Lý File
                            </a>
                            <a href="<?php echo e(route('services')); ?>" class="block px-3 py-2 rounded-md text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 <?php echo e(request()->routeIs('services') || request()->routeIs('billing.manager') ? 'bg-blue-100 dark:bg-blue-900' : ''); ?>">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                                </svg>
                                Gói Dịch Vụ
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
                            <a href="<?php echo e(route('profile.edit')); ?>" class="block px-3 py-2 rounded-md text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                </svg>
                                Chỉnh sửa hồ sơ
                        ...
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <?php if(!request()->routeIs('admin.*')): ?>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="underline hover:no-underline">
                                        → Vào Admin Panel
                                    </a>
                                <?php endif; ?>
                            </div>
            ...
            <footer class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-12 transition-colors duration-200">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div class="text-center text-gray-500 dark:text-gray-400 text-sm">
                        <p>&copy; <?php echo e(date('Y')); ?> VPS Live Stream Control. Được phát triển với ❤️</p>
                        <p class="mt-2">
...
<?php /**PATH D:\laragon\www\ezstream\resources\views\layouts\app.blade.php ENDPATH**/ ?>