            ...
            <div wire:poll.5s="checkPaymentStatus" class="mb-8">
                <?php if($subscription->status === 'ACTIVE'): ?>
                    <div class="bg-green-100 dark:bg-green-900/50 border-l-4 border-green-500 text-green-800 dark:text-green-200 p-6 rounded-lg shadow-md">
                        ...
                        <script>
                            setTimeout(() => { window.location.href = "<?php echo e(route('dashboard')); ?>"; }, 3000);
                        </script>
                    </div>
                <?php else: ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        <div class="text-center">
                            ...
                            <div class="max-w-xs mx-auto bg-white p-4 rounded-lg shadow-inner">
                                <img src="<?php echo e($qrCodeUrl); ?>" alt="VietQR Code" class="w-full h-auto rounded-md">
                            </div>
                                ...
                                <div class="group">
                                 ...
                                 <div class="group">
                                    <label class="text-sm font-medium text-gray-500 dark:text-gray-400">Nội dung chuyển khoản</label>
                                     <div class="flex items-center justify-between">
                                        <p class="text-base font-mono font-semibold text-red-600 dark:text-red-400"><?php echo e($this->paymentCode); ?></p>
                                        <button @click="copyToClipboard('<?php echo e($this->paymentCode); ?>')" class="text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 p-1 rounded-md -mr-1">
                                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.042m-7.332 0c-.055.194-.084.4-.084.612v3.042m0 9.75H12.5a2.25 2.25 0 002.25-2.25V5.25c0-1.03-.842-1.875-1.875-1.875h-1.5c-1.033 0-1.875.845-1.875 1.875v10.5A2.25 2.25 0 007.5 21h6" /></svg>
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 sm:p-8 sticky top-8">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h4 class="font-bold text-lg text-gray-900 dark:text-white"><?php echo e($subscription->servicePackage->name); ?></h4>
                                <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($subscription->servicePackage->description); ?></p>
                            </div>
                        </div>
                        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600 space-y-2 text-sm">
                            <div class="flex items-center text-gray-700 dark:text-gray-300">
                                ...
                                <span><?php echo e($subscription->servicePackage->max_streams); ?> luồng đồng thời</span>
                            </div>
                             <div class="flex items-center text-gray-700 dark:text-gray-300">
                                <svg class="w-4 h-4 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                                <span>Chất lượng tối đa: <?php echo e($subscription->servicePackage->video_resolution); ?>p</span>
                            </div>
                             <div class="flex items-center text-gray-700 dark:text-gray-300">
                                <svg class="w-4 h-4 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                                <span>Lưu trữ: <?php echo e($subscription->servicePackage->storage_limit_gb ? $subscription->servicePackage->storage_limit_gb . ' GB' : 'Không giới hạn'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 text-sm">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-mono text-gray-800 dark:text-gray-100 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded-md"><?php echo e($this->paymentCode); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600 dark:text-gray-300">Ngày tạo:</span>
                            <span class="font-medium text-gray-800 dark:text-gray-100"><?php echo e($transaction->created_at->format('d/m/Y H:i')); ?></span>
                        </div>
                         <div class="flex justify-between items-center">
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex justify-between items-baseline">
                            ...
                            <div class="text-right">
                                <p class="text-3xl font-bold text-blue-600 dark:text-blue-400"><?php echo e(number_format($transaction->amount, 0, ',', '.')); ?> <span class="text-xl">VNĐ</span></p>
                            </div>
                        </div>
                    </div>
    ...
    <?php else: ?>
        <div class="flex items-center justify-center min-h-[calc(100vh-10rem)]">
            <div class="text-center max-w-lg mx-auto p-8">
                ...
                <a href="<?php echo e(route('packages')); ?>" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg shadow-md transition-transform transform hover:scale-105">
...
<?php /**PATH D:\laragon\www\ezstream\resources\views\livewire\payment-manager.blade.php ENDPATH**/ ?>