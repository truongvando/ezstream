...
$__html = app('livewire')->mount($__name, $__params, 'lw-2151915362-0', $__slots ?? [], get_defined_vars());
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-2xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                        ...
                        <div class="bg-purple-50 dark:bg-purple-900/20 px-6 py-3">
                            <a href="<?php echo e(route('file.manager')); ?>" class="text-purple-600 dark:text-purple-400 text-sm font-semibold hover:text-purple-800 dark:hover:text-purple-300">
                                Quản lý files →
                            </a>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-2xl mb-8">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <a href="<?php echo e(route('file.manager')); ?>" class="group bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white rounded-xl p-6 transition-all duration-300 hover:shadow-lg hover:scale-105">
                                <div class="flex items-center space-x-4">
                                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\VPSLiveSeverControl\resources\views/dashboard.blade.php ENDPATH**/ ?>