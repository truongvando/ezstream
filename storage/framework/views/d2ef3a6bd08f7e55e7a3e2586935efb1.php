                            ...
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    ...
                                    <td class="py-3 px-4 text-sm font-medium text-gray-900 dark:text-white">
                                        <span class="truncate block max-w-20">$<?php echo e(number_format($transaction->amount, 2)); ?></span>
                                    </td>
                                    <td class="py-3 px-4 text-sm text-gray-500 dark:text-gray-300">
                                        <span class="truncate block"><?php echo e(optional($transaction->servicePackage)->name ?? 'N/A'); ?></span>
                                    </td>
                                    <td class="py-3 px-4">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2793392331-0', $__slots ?? [], get_defined_vars());
