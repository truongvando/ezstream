...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-900">
                        <?php if(isset($userFiles) && (is_array($userFiles) ? count($userFiles) > 0 : $userFiles->count() > 0)): ?>
                                ...
                                <label class="flex items-center p-3 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer border-b border-gray-200 dark:border-gray-600 last:border-b-0 transition-colors <?php echo e(in_array($file->id, $user_file_ids ?? []) ? 'bg-indigo-50 dark:bg-indigo-900/20' : ''); ?>">
                                    ...
                                    <div class="ml-3 flex-1">
                                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                            ...
                                            <?php if(in_array($file->id, $user_file_ids ?? [])): ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <?php $__currentLoopData = $this->getPlatforms(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $platformName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center p-4 rounded-lg border cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200"
                                ...
                                <span class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($platformName); ?></span>
                            </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
