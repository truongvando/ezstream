                        ...
                        <div class="space-y-4">
                                        ...
                                        <div class="border border-gray-300 dark:border-gray-600 rounded-lg">
                                            <!--[if BLOCK]><![endif]--><?php if(isset($userFiles) && count($userFiles) > 0): ?>
                                                <div class="p-2 bg-gray-50 dark:bg-gray-700 text-xs text-gray-600 dark:text-gray-400 border-b border-gray-200 dark:border-gray-600">
                                                    <div class="flex items-center justify-between">
                                                        <span>Đã chọn: <strong><?php echo e(count($quickSelectedFiles)); ?></strong> file(s)</span>
                                                        <!--[if BLOCK]><![endif]--><?php if(count($quickSelectedFiles) > 1): ?>
                            ...
                            <div class="space-y-4 pt-4 border-t">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" wire:model.live="quickLoop" id="quickLoop" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="quickLoop" class="ml-2 text-sm font-medium flex items-center">
                                        <svg class="w-4 h-4 mr-1.5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                                        </svg>
                                        Loop 24/7 (Lặp lại video liên tục)
                                    </label>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select wire:model.live="quickPlaylistOrder" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white text-sm">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="quickAutoDelete" class="ml-2 text-sm font-medium flex items-center">
                                        ...
                                        Tự động xóa video files sau khi stream
                                    </label>
                                </div>
                                ...
                                <div class="ml-6 p-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded text-xs text-red-700 dark:text-red-400">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <strong>⚠️ Cảnh báo:</strong> Video files sẽ bị xóa vĩnh viễn sau khi stream kết thúc (sau 5 phút).
                                            <br><strong>✅ Lưu ý:</strong> Chỉ xóa video files, thông tin stream sẽ được giữ lại để xem lịch sử.
                                            <br><strong>💡 Khuyến nghị:</strong> Bỏ tick nếu muốn giữ lại video files để tái sử dụng.
                                        </div>
                                    </div>
                                </div>
                                <?php else: ?>
                                <div class="ml-6 text-xs text-green-600 dark:text-green-400">
                                    ✅ Video files sẽ được giữ lại sau khi stream kết thúc
                                </div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
