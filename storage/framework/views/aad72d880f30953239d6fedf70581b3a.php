                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($stats['total_transactions']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e(number_format($stats['total_revenue'], 0, ',', '.')); ?> VNĐ</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($stats['pending_transactions']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($stats['failed_transactions']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['wire:model.live' => 'search','type' => 'text','class' => 'block w-full','placeholder' => 'Search transactions...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'search','type' => 'text','class' => 'block w-full','placeholder' => 'Search transactions...']); ?>
...
<?php endif; ?>
                        ...
                        <div>
                            <select wire:model.live="statusFilter" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                ...
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($sortField === 'id'): ?>
                                            <!--[if BLOCK]><![endif]--><?php if($sortDirection === 'asc'): ?> ↑ <?php else: ?> ↓ <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <tr>
                                                ...
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <div class="h-10 w-10 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center">
                                                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                                            <?php echo e(strtoupper(substr($transaction->user->name, 0, 2))); ?>

                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="ml-4">
                                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($transaction->user->name); ?></div>
                                                    <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($transaction->user->email); ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e(number_format($transaction->amount, 0, ',', '.')); ?> VNĐ</td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900 dark:text-gray-100 max-w-xs truncate">
                                                <?php echo e($transaction->description ?? 'No description'); ?>

                                            </div>
                                            <!--[if BLOCK]><![endif]--><?php if($transaction->gateway_transaction_id): ?>
                                                <div class="text-xs text-gray-500 dark:text-gray-400">
                                                    Gateway ID: <?php echo e($transaction->gateway_transaction_id); ?>

                                                </div>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                            <div><?php echo e($transaction->created_at->format('M j, Y')); ?></div>
                                            <div class="text-xs"><?php echo e($transaction->created_at->format('g:i A')); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button wire:click="editTransaction(<?php echo e($transaction->id); ?>)" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-200">Sửa</button>
                                        </td>
                                    </tr>
                ...
                <form wire:submit.prevent="updateTransaction">
                    <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white" id="modal-title">
                            Cập nhật giao dịch #<?php echo e($editingTransaction->payment_code); ?>
...
<?php /**PATH D:\laragon\www\ezstream\resources\views/livewire/admin/transaction-management.blade.php ENDPATH**/ ?>