<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div>
                    <div class="text-2xl font-bold text-blue-900 dark:text-blue-100"><?php echo e($stats['total_tools']); ?></div>
        ...
        <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div>
                    <div class="text-2xl font-bold text-yellow-900 dark:text-yellow-100"><?php echo e($stats['featured_tools']); ?></div>
        ...
        <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div>
                    <div class="text-2xl font-bold text-green-900 dark:text-green-100"><?php echo e($stats['on_sale_tools']); ?></div>
    ...
    <div class="flex flex-wrap gap-3 mb-6">
        ...
        <!--[if BLOCK]><![endif]--><?php if($search || $showFeaturedOnly || $priceRange !== 'all'): ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $tools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tool): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-200 bg-white dark:bg-gray-700">
                <!-- Tool Image -->
                <div class="relative">
                    <img src="<?php echo e($tool->image); ?>" alt="<?php echo e($tool->name); ?>" 
                ...
                <!-- Tool Info -->
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2"><?php echo e($tool->name); ?></h3>
                    <p class="text-gray-600 dark:text-gray-400 text-sm mb-3 line-clamp-2"><?php echo e($tool->short_description); ?></p>
                    
                    <!-- Features -->
                    <!--[if BLOCK]><![endif]--><?php if($tool->features && count($tool->features) > 0): ?>
                        <div class="mb-3">
                            <div class="flex flex-wrap gap-1">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = array_slice($tool->features, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-300 text-xs px-2 py-1 rounded">
                                        <?php echo e($feature); ?>

                                    </span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <!--[if BLOCK]><![endif]--><?php if(count($tool->features) > 3): ?>
                                    <span class="text-gray-500 text-xs">+<?php echo e(count($tool->features) - 3); ?> more</span>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!-- Pagination -->
    <!--[if BLOCK]><![endif]--><?php if($tools->hasPages()): ?>
        <div class="mt-6">
...
<?php /**PATH D:\laragon\www\ezstream\resources\views/livewire/tool-store.blade.php ENDPATH**/ ?>