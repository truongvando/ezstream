        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="inline-flex items-center px-6 py-3 rounded-2xl glass mb-8 animate-fade-in">
                ...
                <span class="font-mono text-sm font-semibold flex items-center">
                    ...
                    LIVE - <?php echo e($stats['active_streams']); ?>+ streams đang hoạt động
                </span>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-6xl mx-auto animate-fade-in mb-16">
                ...
                <div class="glass rounded-2xl p-6 hover-lift">
                    <div class="text-4xl md:text-5xl font-black gradient-text mb-2"><?php echo e($stats['total_users']); ?>+</div>
    ...
    <section class="relative py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            ...
            <p class="text-xl md:text-2xl text-white/80 mb-12 max-w-3xl mx-auto leading-relaxed">
                Tham gia cùng <span class="text-white font-bold"><?php echo e($stats['total_users']); ?>+ khách hàng</span> và doanh nghiệp
