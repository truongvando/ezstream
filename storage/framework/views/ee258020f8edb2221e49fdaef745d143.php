...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button','data' => ['wire:click' => 'deleteFile','class' => 'w-full sm:w-auto sm:ml-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'deleteFile','class' => 'w-full sm:w-auto sm:ml-3']); ?>
                    Xóa
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($files->count() > 0): ?>
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 hover:shadow-md transition-shadow">
                                    ...
                                    <h3 class="font-medium text-gray-900 dark:text-gray-100 text-sm mb-2 truncate" title="<?php echo e($file->original_name); ?>">
                                        <?php echo e($file->original_name); ?>

                                    </h3>

                                    <div class="text-xs text-gray-500 dark:text-gray-400 space-y-1">
                                        <p>📦 <?php echo e(\Illuminate\Support\Number::fileSize($file->size)); ?></p>
                                        <p>📅 <?php echo e($file->created_at->format('d/m/Y H:i')); ?></p>
                                        <p>
                                            <!--[if BLOCK]><![endif]--><?php if($file->disk === 'bunny_cdn'): ?>
                                                <span class="text-green-600">☁️ Server</span>
                                            <?php elseif($file->disk === 'google_drive'): ?>
                                        ...
                                        <p>
                                            <!--[if BLOCK]><![endif]--><?php if($file->status === 'ready'): ?>
                                                <span class="text-green-600">✅ Sẵn sàng</span>
                                            <?php elseif($file->status === 'uploading'): ?>
                                                <span class="text-yellow-600">⏳ Đang tải</span>
                                            <?php elseif($file->status === 'processing'): ?>
...
<?php /**PATH D:\laragon\www\ezstream\resources\views/livewire/file-upload.blade.php ENDPATH**/ ?>